        ...
        <div className="max-w-md mx-auto">
          <div className="flex items-center gap-4">
            <button
              ...
              className="w-[40px] aspect-square flex items-center justify-center text-[18px] rounded-full bg-zinc-100"
            >
              <FiArrowLeft />
            </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 text-[14px] border bg-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 ${

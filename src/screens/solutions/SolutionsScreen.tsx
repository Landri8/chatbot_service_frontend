  ...
  const testimonials = [
    {
      ...
      altText: "Coursera",
      description: "Coursera enhances student support with our AI chatbot, providing instant course recommendations and academic assistance. Available 24/7, it ensures seamless communication, reduces wait times, and improves student satisfaction, leading to higher engagement and course completion rates.",
      brandLogoSrc: "/assets/images/coursera_logo.png"
    },
    {
      logoSrc: "/assets/images/who_org.png",
      altText: "World Health Organization",
      description: "WHO utilizes our AI chatbot to deliver real-time health information and combat misinformation. It provides instant, accurate responses in multiple languages, improving accessibility and public engagement. ",
